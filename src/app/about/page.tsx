...
export default function AboutPage() {
  return (
    <section className="mx-auto w-full max-w-[72rem] px-5 py-16 sm:px-8 sm:py-24 lg:px-12">
      ...
      <p className="mt-8 max-w-[46rem] text-[1.08rem] leading-8 text-[color:var(--muted)] sm:text-[1.18rem] sm:leading-9">
        {profile.summary}
      </p>
      <div className="mt-12 grid gap-10 border-t border-[color:var(--line)] pt-8 lg:grid-cols-[minmax(0,1fr)_18rem] lg:gap-16">
        <div className="grid gap-6 text-base leading-8 text-[color:var(--muted)]">
          <p>
            Across recent roles, the work has consistently centered on redesigning complex
            surfaces, improving usability for high-stakes workflows, and putting stronger frontend
            practices in place so products become easier to maintain over time.
          </p>
          <p>
            That has meant responsive refactors, dashboard redesigns, test coverage work,
