...
import logoParadime from '@/images/logos/paradimelabsLogo.jpeg';
...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="https://drive.google.com/file/d/1Aj95zJd15TB51kDh7l3FpoWZI2dJXaF3/view" variant="secondary" className="group mt-6 w-full">
        View Resume
      ...
      <Container className="mt-[20px]">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            ...
            <SocialLink
              href="https://github.com/rimildeyjsr"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/rimildeyjsr/"
