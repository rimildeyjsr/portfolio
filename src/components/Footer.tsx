...
export function Footer() {
  return (
    <footer className="border-t border-[color:var(--line)] py-8">
      <div className="mx-auto flex w-full max-w-[88rem] flex-col gap-4 px-5 text-sm text-[color:var(--muted)] sm:px-8 md:flex-row md:items-center md:justify-between lg:px-12">
        <p>Built as an editorial dossier for senior frontend opportunities.</p>
